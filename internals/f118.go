...
func f118(ctx *Context, l0 int32) int32 {
	...
	s0i32 = l9
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6184):]))
	// set_local
	l10 = s0i32
	// const
	s0i32 = 1
...
lbl7:
	...
	s3i64 = l57
	// call
	f506(ctx, s0i32, s1i64, s2i64, s3i64)
	// end_block
lbl8:
	// br
	goto lbl4
...
lbl0:
	...
	s0i32 = l3
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+63)])
	// set_local
	l128 = s0i32
	// const
	s0i32 = 1
