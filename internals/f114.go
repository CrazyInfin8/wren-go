...
func f114(ctx *Context, l0 int32, l1 int32) {
	...
	s1i32 = l5
	// store: i32.store8
	ctx.Mem[int(s0i32+107)] = uint8(s1i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	...
	s1i32 = l18
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+96):], uint32(s1i32))
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+108):]))
...
lbl0:
	...
	s0i32 = l4
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+107)])
	// set_local
	l45 = s0i32
	// const
	s0i32 = 1
...
lbl2:
	...
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+96):]))
	// set_local
	l55 = s0i32
	// get_local
	s0i32 = l54
