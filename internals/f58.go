...
func f58(ctx *Context, l0 int32, l1 int32) {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
	...
	s0i32 = l11
	// load: i64.load
	s0i64 = int64(binary.LittleEndian.Uint64(ctx.Mem[int(s0i32+20852):]))
	// set_local
	l12 = s0i64
	// get_local
	s0i32 = l10
	...
	s0i32 = l11
	// load: i64.load
	s0i64 = int64(binary.LittleEndian.Uint64(ctx.Mem[int(s0i32+20844):]))
	// set_local
	l13 = s0i64
	// get_local
	s0i32 = l8
