...
func f153(ctx *Context, l0 int32, l1 int32, l2 int32) int32 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	s4i32 = l16
	// call
	s0i32 = f320(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// set_local
	l17 = s0i32
	// get_local
	s0i32 = l5
