...
func f432(ctx *Context, l0 int32, l1 int32, l2 int32) {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	s3i32 = l26
	// call
	s0i64 = f529(ctx, s0i32, s1i64, s2i64, s3i32)
	// set_local
	l27 = s0i64
	// get_local
	s0i32 = l5
...
lbl1:
	...
	s3i32 = l44
	// call
	s0i32 = f384(ctx, s0i32, s1i32, s2i32, s3i32)
	// set_local
	l45 = s0i32
	// get_local
	s0i32 = l5
