...
func f595(ctx *Context, l0 int32, l1 int32, l2 int32) float64 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
...
lbl60:
	...
	s4i32 = l2
	// call
	s0f64 = f596(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// set_local
	l7 = s0f64
	// br
	goto lbl0
