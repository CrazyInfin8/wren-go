...
func f504(ctx *Context, l0 int32, l1 int32) int32 {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
...
lbl3:
	...
	s4i32 = l115
	// call
	f511(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6376):]))
	...
	s3i32 = l124
	// call
	s0i32 = f512(ctx, s0i32, s1i32, s2i32, s3i32)
	// set_local
	l128 = s0i32
	// get_local
	s0i32 = l4
...
lbl4:
	...
	s3i32 = l159
	// call
	f513(ctx, s0i32, s1i32, s2i32, s3i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6360):]))
