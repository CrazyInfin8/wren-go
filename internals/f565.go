...
lbl0:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+41608):]))
	// tee_local
	l0 = s0i32
	// unary: i32.eqz
	if s0i32 == 0 {
...
lbl4:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+41368):]))
	// tee_local
	l0 = s0i32
	// unary: i32.eqz
	if s0i32 == 0 {
...
lbl6:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+41488):]))
	// tee_local
	l0 = s0i32
	// unary: i32.eqz
	if s0i32 == 0 {
