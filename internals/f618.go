...
func f618(ctx *Context, l0 float64) float64 {
	var l1 int64
	_ = l1
	var l2 int32
	_ = l2
...
lbl1:
	...
	s0i32 = 0
	// load: f64.load
	s0f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s0i32+26672):]))
	// get_local
	s1f64 = l0
	// binary: f64.mul
	s0f64 = s0f64 * s1f64
	...
	s1i32 = 0
	// load: f64.load
	s1f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s1i32+26680):]))
	// tee_local
	l4 = s1f64
	// binary: f64.add
	s0f64 = s0f64 + s1f64
	...
	s1i32 = 0
	// load: f64.load
	s1f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s1i32+26696):]))
	// binary: f64.mul
	s0f64 = s0f64 * s1f64
	// get_local
	s1f64 = l4
	...
	s2i32 = 0
	// load: f64.load
	s2f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s2i32+26688):]))
	// binary: f64.mul
	s1f64 = s1f64 * s2f64
	// get_local
	s2f64 = l0
	...
	s2i64 = l1
	// call
	s0f64 = f619(ctx, s0f64, s1i64, s2i64)
	// return
	return s0f64
	// end_block
lbl5:
