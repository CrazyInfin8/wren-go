...
func f509(ctx *Context, l0 int32, l1 int32) int32 {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
	...
	s1i32 = l15
	// store: i32.store8
	ctx.Mem[int(s0i32+6383)] = uint8(s1i32)
	// br
	goto lbl0
	// end_block
lbl1:
	...
	s1i32 = l20
	// store: i32.store8
	ctx.Mem[int(s0i32+6375)] = uint8(s1i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6376):]))
	...
	s1i32 = l25
	// store: i32.store8
	ctx.Mem[int(s0i32+6374)] = uint8(s1i32)
	// get_local
	s0i32 = l4
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+6374)])
	// set_local
	l26 = s0i32
	// get_local
	s0i32 = l4
	...
	s1i32 = l38
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+6368):], uint32(s1i32))
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6376):]))
	...
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6368):]))
	// set_local
	l41 = s0i32
	// const
	s0i32 = 0
...
lbl2:
	...
	s1i32 = l86
	// store: i32.store8
	ctx.Mem[int(s0i32+6340)] = uint8(s1i32)
	// get_local
	s0i32 = l4
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+6374)])
...
lbl3:
	...
	s0i32 = l4
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+6375)])
	// set_local
	l110 = s0i32
	// get_local
	s0i32 = l4
	...
	s4i32 = l115
	// call
	f516(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6376):]))
	...
	s3i32 = l124
	// call
	s0i32 = f517(ctx, s0i32, s1i32, s2i32, s3i32)
	// set_local
	l128 = s0i32
	// get_local
	s0i32 = l4
...
lbl4:
	...
	s3i32 = l159
	// call
	f518(ctx, s0i32, s1i32, s2i32, s3i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+6360):]))
...
lbl0:
	...
	s0i32 = l4
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+6383)])
	// set_local
	l192 = s0i32
	// const
	s0i32 = 1
