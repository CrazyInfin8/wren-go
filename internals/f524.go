...
func f524(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	var l6 int32
	_ = l6
	var l7 int32
	_ = l7
...
lbl0:
	...
	s4i32 = l48
	// call
	f471(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// const
	s0i32 = 8
	// set_local
	l54 = s0i32
...
lbl2:
	...
	s4i32 = l64
	// call
	f475(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// get_local
	s0i32 = l8
	// set_local
	l68 = s0i32
