...
func f594(ctx *Context, l0 int32, l1 int32, l2 int32) float64 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
...
lbl60:
	...
	s4i32 = l2
	// call
	s0f64 = f595(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// set_local
	l7 = s0f64
	// br
	goto lbl0
...
lbl132:
	...
	s4i32 = s4i32 - s5i32
	// call
	s3f64 = f630(ctx, s3f64, s4i32)
	// call
	s2f64 = f619(ctx, s2f64, s3f64)
	// tee_local
	l7 = s2f64
	// binary: f64.sub
	s1f64 = s1f64 - s2f64
