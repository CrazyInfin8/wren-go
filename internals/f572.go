...
func f572(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	var l5 int32
	_ = l5
	var l6 int32
	_ = l6
...
lbl11:
	...
	s2i32 = l0
	// call
	s0i32 = f567(ctx, s0i32, s1i32, s2i32)
	// end_block
lbl14:
	// get_local
	s0i32 = l20
...
lbl184:
	...
	s4i32 = 0
	// call
	f574(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// br
	goto lbl174
	// end_block
lbl175:
