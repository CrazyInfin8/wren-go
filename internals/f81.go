...
func f81(ctx *Context, l0 int32, l1 int32) {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
...
lbl1:
	...
	s2i32 = l26
	// call
	s0i32 = f83(ctx, s0i32, s1i32, s2i32)
	// set_local
	l27 = s0i32
	// const
	s0i32 = -1
...
lbl2:
	...
	s3i32 = l45
	// call
	f85(ctx, s0i32, s1i32, s2i32, s3i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+44):]))
