...
func f626(ctx *Context, l0 float64, l1 float64) float64 {
	var l2 int64
	_ = l2
	var l3 int32
	_ = l3
...
lbl1:
	...
	s3i32 = 0
	// load: f64.load
	s3f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s3i32+35216):]))
	// tee_local
	l13 = s3f64
	// binary: f64.mul
	s2f64 = s2f64 * s3f64
	...
	s3i32 = 0
	// load: f64.load
	s3f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s3i32+35200):]))
	// binary: f64.mul
	s2f64 = s2f64 * s3f64
	// get_local
	s3i32 = l5
	...
	s5i32 = 0
	// load: f64.load
	s5f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s5i32+35208):]))
	// binary: f64.mul
	s4f64 = s4f64 * s5f64
	// get_local
	s5i32 = l5
	...
	s7i32 = 0
	// load: f64.load
	s7f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s7i32+35264):]))
	// binary: f64.mul
	s6f64 = s6f64 * s7f64
	// const
	s7i32 = 0
	// load: f64.load
	s7f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s7i32+35256):]))
	// binary: f64.add
	s6f64 = s6f64 + s7f64
	// binary: f64.mul
	s5f64 = s5f64 * s6f64
	...
	s7i32 = 0
	// load: f64.load
	s7f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s7i32+35248):]))
	// binary: f64.mul
	s6f64 = s6f64 * s7f64
	// const
	s7i32 = 0
	// load: f64.load
	s7f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s7i32+35240):]))
	// binary: f64.add
	s6f64 = s6f64 + s7f64
	// binary: f64.add
	s5f64 = s5f64 + s6f64
	...
	s6i32 = 0
	// load: f64.load
	s6f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s6i32+35232):]))
	// binary: f64.mul
	s5f64 = s5f64 * s6f64
	// const
	s6i32 = 0
	// load: f64.load
	s6f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s6i32+35224):]))
	// binary: f64.add
	s5f64 = s5f64 + s6f64
	// binary: f64.add
	s4f64 = s4f64 + s5f64
...
lbl12:
	...
	s2i32 = 0
	// load: f64.load
	s2f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s2i32+26608):]))
	// binary: f64.mul
	s1f64 = s1f64 * s2f64
	// const
	s2i32 = 0
	// load: f64.load
	s2f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s2i32+26616):]))
	// tee_local
	l0 = s2f64
	// binary: f64.add
	s1f64 = s1f64 + s2f64
	...
	s2i32 = 0
	// load: f64.load
	s2f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s2i32+26632):]))
	// binary: f64.mul
	s1f64 = s1f64 * s2f64
	// get_local
	s2f64 = l0
	...
	s3i32 = 0
	// load: f64.load
	s3f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s3i32+26624):]))
	// binary: f64.mul
	s2f64 = s2f64 * s3f64
	// get_local
	s3f64 = l13
	...
	s2i64 = l6
	// call
	s0f64 = f628(ctx, s0f64, s1i64, s2i64)
	// return
	return s0f64
	// end_block
lbl15:
