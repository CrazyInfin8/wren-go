...
func f327(ctx *Context, l0 int32, l1 float64) int64 {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
	...
	s1f64 = l1
	// store: f64.store
	binary.LittleEndian.PutUint64(ctx.Mem[int(s0i32+40):], math.Float64bits(s1f64))
	// get_local
	s0i32 = l4
	// load: f64.load
	s0f64 = math.Float64frombits(binary.LittleEndian.Uint64(ctx.Mem[int(s0i32+40):]))
	// set_local
	l5 = s0f64
	// get_local
	s0f64 = l5
