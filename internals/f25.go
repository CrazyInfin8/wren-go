...
lbl4:
	...
	s0i32 = l3
	// load: i32.load8_s
	s0i32 = int32(int8(ctx.Mem[int(s0i32+27)]))
	// set_local
	l59 = s0i32
	// const
	s0i32 = -9
...
lbl34:
	...
	s1i32 = l110
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+128):], uint32(s1i32))
	// get_local
	s0i32 = l3
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+28):]))
...
lbl19:
	...
	s3i32 = l176
	// call
	f101(ctx, s0i32, s1i32, s2i32, s3i32)
	// br
	goto lbl0
	// end_block
lbl18:
