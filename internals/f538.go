...
func f538(ctx *Context, l0 int32) {
	var l1 int32
	_ = l1
	var l2 int32
	_ = l2
...
lbl1:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+41600):]))
	// binary: i32.ne
	if s0i32 != s1i32 {
		s0i32 = 1
	} else {
...
lbl30:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+41612):]))
	// const
	s2i32 = -1
	// binary: i32.add
	s1i32 = s1i32 + s2i32
