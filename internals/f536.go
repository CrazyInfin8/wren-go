...
func f536(ctx *Context, l0 int32) int32 {
	var l1 int32
	_ = l1
	var l2 int32
	_ = l2
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+41604):]))
	// br_if
	if s0i32 != 0 {
		goto lbl0
	}
	...
	s1i64 = -1
	// store: i64.store
	binary.LittleEndian.PutUint64(ctx.Mem[int(s0i32+42064):], uint64(s1i64))
	// const
	s0i32 = 0
	// const
	...
	l4 = s1i32
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+42052):], uint32(s1i32))
	// const
	s0i32 = 0
	// const
	s1i32 = 0
...
lbl1:
	...
	s1i32 = l4
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+41616):], uint32(s1i32))
	// const
	s0i32 = 0
	// const
	s1i32 = -1
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+41612):], uint32(s1i32))
	// loop
lbl2:
	// get_local
	s0i32 = l3
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+42068):]))
	// store: i32.store
...
lbl19:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+41600):]))
	// set_local
	l4 = s0i32
	// block
	// block
...
lbl49:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+42020):]))
	// tee_local
	l3 = s0i32
	// unary: i32.eqz
	if s0i32 == 0 {
...
lbl50:
	...
	s0i32 = 0
	// load: i32.load8_u
	s0i32 = int32(ctx.Mem[int(s0i32+42024)])
	// const
	s1i32 = 4
	// binary: i32.and
	s0i32 = s0i32 & s1i32
...
lbl54:
	...
	s0i32 = 0
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+42056):]))
	// tee_local
	l3 = s0i32
	// const
	s1i32 = -1
...
lbl9:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+42024):]))
	// const
	s2i32 = 4
	// binary: i32.or
	s1i32 = s1i32 | s2i32
...
lbl7:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+42012):]))
	// get_local
	s2i32 = l6
	// binary: i32.add
	s1i32 = s1i32 + s2i32
	...
	l3 = s1i32
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+42012):], uint32(s1i32))
	// block
	// get_local
	s0i32 = l3
	// const
...
lbl68:
	...
	s1i32 = 0
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+42040):], uint32(s1i32))
	// loop
lbl70:
	// get_local
	s0i32 = l3
...
lbl65:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+41592):]))
	// get_local
	s2i32 = l6
	// binary: i32.add
	s1i32 = s1i32 + s2i32
...
lbl64:
	...
	s1i32 = 0
	// load: i32.load
	s1i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s1i32+41596):]))
	// tee_local
	l8 = s1i32
	// binary: i32.ge_u
	if uint32(s0i32) >= uint32(s1i32) {
...
lbl75:
	...
	s1i32 = 0
	// load: i64.load
	s1i64 = int64(binary.LittleEndian.Uint64(ctx.Mem[int(s1i32+42036):]))
	// store: i64.store
	...
	s1i32 = s1i32 + s2i32
	// store: i32.store
	binary.LittleEndian.PutUint32(ctx.Mem[int(s0i32+42036):], uint32(s1i32))
	// const
	s0i32 = 0
	// get_local
	s1i32 = l6
