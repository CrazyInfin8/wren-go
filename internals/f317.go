...
lbl98:
	...
	s2i32 = l599
	// call
	s0i32 = f418(ctx, s0i32, s1i64, s2i32)
	// set_local
	l600 = s0i32
	// const
	s0i32 = 1
...
lbl97:
	...
	s4i32 = l684
	// call
	f419(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+244):]))
...
lbl7:
	...
	s5i64 = l1920
	// call
	f426(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5i64)
	// get_local
	s0i32 = l4
	// load: i32.load
	s0i32 = int32(binary.LittleEndian.Uint32(ctx.Mem[int(s0i32+244):]))
...
lbl4:
	...
	s2i64 = l2204
	// call
	s0i64 = f428(ctx, s0i32, s1i32, s2i64)
	// set_local
	l2205 = s0i64
	// get_local
	s0i32 = l4
