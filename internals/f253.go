...
func f253(ctx *Context, l0 int32, l1 int32) int32 {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
...
lbl2:
	...
	s2i32 = l39
	// call
	s0i64 = f337(ctx, s0i32, s1i32, s2i32)
	// set_local
	l40 = s0i64
	// get_local
	s0i32 = l4
...
lbl3:
	...
	s3i32 = l73
	// call
	s0i32 = f338(ctx, s0i32, s1i32, s2i32, s3i32)
	// set_local
	l74 = s0i32
	// get_local
	s0i32 = l4
...
lbl4:
	...
	s4i32 = l89
	// call
	s0i64 = f339(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	// set_local
	l90 = s0i64
	// get_local
	s0i32 = l4
